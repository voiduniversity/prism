...
def easyFrame(root):
    ...
    lineOne = ctk.CTkLabel(codeFrame, text=pythonCodeLines[0], font=codingFont, text_color="#F2F2F2")
    lineTwo = ctk.CTkLabel(codeFrame, text=pythonCodeLines[1], font=codingFont, text_color="#F2F2F2")
    lineThree = ctk.CTkLabel(codeFrame, text=pythonCodeLines[2], font=codingFont, text_color="#F2F2F2")
    lineFour = ctk.CTkLabel(codeFrame, text=pythonCodeLines[3], font=codingFont, text_color="#F2F2F2")
    lineFive = ctk.CTkLabel(codeFrame, text=pythonCodeLines[4], font=codingFont, text_color="#F2F2F2")
    lineSix = ctk.CTkLabel(codeFrame, text=pythonCodeLines[5], font=codingFont, text_color="#F2F2F2")
    lineSeven = ctk.CTkLabel(codeFrame, text=pythonCodeLines[6], font=codingFont, text_color="#F2F2F2")
    ...
    lineThree.place(x=75, y=68)
    lineFour.place(x=81, y=88)
    lineFive.place(x=59, y=132)
    lineSix.place(x=75, y=152)
    lineSeven.place(x=61, y=174)
